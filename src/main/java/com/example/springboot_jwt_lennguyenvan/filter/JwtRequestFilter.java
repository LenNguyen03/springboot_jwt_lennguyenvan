package com.example.springboot_jwt_lennguyenvan.filter;
...
import com.example.springboot_jwt_lennguyenvan.service.TokenService;
import com.example.springboot_jwt_lennguyenvan.util.JwtUtil;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (null != user && null != token && token.getTokenExp().after(new Date())) {
